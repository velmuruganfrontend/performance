<template>
    <div>
        <app-meta 
            :cb-title="'Free Trial with Premium Plans'" 
            :cb-desc="'Offer a paid plan as a free trial, without a credit card requirement.'" 
            :cb-url="'/guide/trials/free-trial-with-premium-plans/'" 
            :cb-image="''"
                ...
                <div class="container block-space text-15">        
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <li class="active">Free Trial with Premium Plans</li>
                            </ol>
                            
                            <div class="block-trials-detail">
                                    <div class="block-trial-section">
                                        <h1>Free Trial with Premium Plans</h1>
                                        <h4>Plans</h4>
                                        <p><span style="font-weight:400;">Basic, Pro, Premium</span> etc. all with a stipulated trial period.</p>
                                    </div>
            
                                    <div class="block-trial-section">
                                        <h4 id="scenario">Scenario</h4>
                                        <p>Tim signs up for your product and by default you put him on a free trial (limited). When the trial period is about to expire, you send him an email asking him to pick a plan. After he chooses the plan, you ask him to key in his card information. If he doesn’t pick a plan, his account will be disabled. Shopify would be a great example of this model.</p>
            
                                        <img src="/static/website/version/images/guides/free-trial-with-paid-plans.png" class="img-responsive block-tb-space">
                                    ...
                                    <div class="block-trial-section">
                                        ...
                                        <p>Set up plans that correspond to your Pricing Structure.</p>
