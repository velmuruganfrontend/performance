                    ...
                    <div class="cn-article" style="color: #00001E;">
                        ...
                        <div class="cn-article__content">
                            <div class="cn-article__heading">
                                Your free sandbox test account lets you
                            </div>
                            <div class="cn-article__list">
                                <div class="cn-article__item cn-article__item--black">
                                    Simulate customers, products, and plans.
                                </div>
                                <div class="cn-article__item cn-article__item--black">
                                    Test transactions with embeddable checkout pages.
                                </div>
                                <div class="cn-article__item cn-article__item--black">
                                    Battle-test recurring billing workflows.
                                </div>
                                <div class="cn-article__item cn-article__item--black">
                                    Setup and test your product & payment integrations.
                                </div>
                                <div class="cn-article__item cn-article__item--black">
                                    Get hands on without the fear of breaking things.
                                </div>
                                <div class="cn-article__item cn-article__item--black">
                                    Go LIVE <strong>only</strong> when you are ready!
                                </div>
                            </div>
                        </div>
                        <!-- =======================================================================
                        ...
                        <div class="cn-article__footer">
                            <div class="cn-article__desc">
                                Thousands of businessess love and trust Chargebee
                            </div>
                            <div class="cn-logos">
                                <div class="cn-logo">
                        ...
                        <div class="cn-form__header">
                            <div class="cn-header">
                                ...
                                <div class="cn-header__group">
                                    <div class="cn-header__title">Get your free Chargebee sandbox account</div>
                                ...
                                <div class="cn-form__actions" style="display: block;">
                                    <div class="cn-form__action">
                                        <div class="cn-form__field" style="margin-left: 0">
                                            <input id="sign-up-submit" type="submit" value="Access Sandbox →" class="cn-form__btn" onclick="ga('send', 'event', 'website', 'signup-action', 'button-signup');" disabled>
                                        </div>
