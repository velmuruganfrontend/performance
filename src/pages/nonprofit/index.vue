...
<template>
  <div>
    ...
    ==================================================================== -->
    <app-meta 
      :cb-title="'Chargebee for Nonprofits'" 
      :cb-desc="'With Chargebee you can forget about billing troubles, and focus on taking your work to more of those who need it.'" 
      :cb-url="'/nonprofit/'" 
      :cb-image="''"
      :cb-style="'/static/website/version/styles/bootstrap.css'"
      :cb-head-script="''"
      :cb-body-script="'/static/website/version/scripts/typeform.js'"
    ...
    <div class="cb-body">
      <div class="pad-top-head-height">
        ...
        <section class="well no-round no-bor no-mar no-pad" style="display: none;">
            <div class="container text-center block-space">
                <h1 class="ProximaNova-Bold hr-line text-uppercase">Nonprofits</h1>
            </div>
        </section>
        <div class="container block-space"> 
            <div class="typeform-widget np-form" data-url="https://chargebee.typeform.com/to/Yj7gVP" data-text="Not for Profit Form" style="width:100%;height:600px;"></div>
        </div>
