<template>
    <div>
        <app-meta 
            :cb-title="'Chargebee + Checkout.com | Scale Subscriptions Globally'" 
            :cb-desc="'Unlock more value with the combined power of Chargebee and Checkout.com by accepting payments globally, smarter fraud prevention, retry logic and simplified reconciliation.'" 
            :cb-url="'/partners/checkout-com/'" 
            :cb-image="''"
        ...
        <div class="cb-body">
            <div class="cp-l-main">
                            ...
                            <div class="row">
                                <div class="col-md-12 text-center">
                                    <div class="cp-hero__header">
                                        <div class="cp-label">
                                            <div class="cp-label__text v-h-center"><svg width="110" height="34"><use xlink:href="#chargebee-logo-black"></use></svg> <span class="both-space">+</span> <img src="/static/resources/payment-gateway/germany/checkout-com.svg"/></div> 
                                        </div>
                                        <h1 class="cp-hero__title">Scale your Subscription Business <br class="hidden-xs">with Connected Payments</h1>
                                    </div>
                                    <div class="cp-hero__body">
                                        <p class="cp-hero__desc">Unlock more value in every transaction with Chargebee’s preferred digital payments provider, Checkout.com.</p>
                                    ...
                                    <div class="cp-hero__footer">
                                        <p class="cp-hero__message">
                                            Transparent and tailored, Checkout.com reduces the operational and processing costs of your payments. <br />
                                            <span class="cp-block__action"><a href="/docs/checkout-gateway.html">Read how it works → </a></span> 
                                        </p>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="cp-slider__header">
                                        <div class="cp-slider__title">
                                            Deliver seamless global card payments and extend the customer lifecycle
                                        </div>
                                        <p class="cp-slider__label">Grow with Chargebee and Checkout.com</p>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                        ...
                                        <div class="cp-slider__container">
                                            <div class="cp-slider__item">
                                                <div class="cp-slider__progress">
                                                    ...
                                                    <p class="cp-slider__desc">Supercharge payments in all your markets. Power growth across the globe with 150+ currencies and domestic processing in almost 50 countries.</p>
                                                </div>
                                            ...
                                            <div class="cp-slider__item">
                                                <div class="cp-slider__progress">
                                                    ...
                                                    <p class="cp-slider__desc">Strike the right balance between payment fraud protection and approval rates. Respond in real-time using machine learning models on millions of global transactions.</p>
                                                </div>
                                                <a href="https://www.chargebee.com/recurring-payments/multicurrency/" class="cp-slider__action">See Chargebee supported currencies →</a>
                                                <div class="cp-slider__sep"></div>
                                            </div>
                                            <div class="cp-slider__item">
                                                <div class="cp-slider__progress">
                                                    <div class="cp-slider__heading">
                                                       The power behind your payment retry logic
                                                    </div>
                                                    <p class="cp-slider__desc">Understand every payment Checkout.com processes. And combine insights with Chargebee’s smart retry logic to reduce declined payments.</p>
                                                </div>
                                                <a href="https://www.chargebee.com/recurring-payments/multicurrency/" class="cp-slider__action">See Chargebee supported currencies →</a>
                                                <div class="cp-slider__sep"></div>
                                            </div>
                                            <div class="cp-slider__item">
                                                <div class="cp-slider__progress">
                                                    <div class="cp-slider__heading">
                                                       Don’t let expired cards hold you back 
                                                    </div>
                                                    <p class="cp-slider__desc">Reduce the friction of missed payments. Automate updating card details, before they expire.</p>
                                                </div>
                                                <a href="https://www.chargebee.com/recurring-payments/multicurrency/" class="cp-slider__action">See Chargebee supported currencies →</a>
                                                <div class="cp-slider__sep"></div>
                                            </div>
                                            <div class="cp-slider__item">
                                                <div class="cp-slider__progress">
                                                    ...
                                                    <p class="cp-slider__desc">Help your business make smarter and faster decisions. Automate reconciliation process with real-time access to financial data.</p>
                                                </div>
                                                <a href="https://www.chargebee.com/recurring-payments/multicurrency/" class="cp-slider__action">See Chargebee supported currencies →</a>
                                            </div>
                                        </div>
                ...
                <section class="cp-l-main__row">
                    <div class="cp-medias">
                        <div class="container">
                            <div class="cp-medias__title">The Chargebee+Checkout.com integration</div>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="cp-media">
                                        ...
                                        <div class="cp-media__content">
                                            ...
                                            <p class="cp-media__desc">US, Latin America, Europe, Middle East and Asia </p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="cp-media">
                                        ...
                                        <div class="cp-media__content">
                                            ...
                                            <p class="cp-media__desc">From late-stage startups to global Enterprise merchants</p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 hidden-sm hidden-xs">
                                    ...
                                    <div class="cp-scrollspy__header" data-affix-after="#before-affix" id="ca-nav-affix">
                                        <div>
                                            <div class="cp-scrollspy__label">Explore international markets with Checkout.com.</div>
                                        ...
                                        <ul class="cp-scrollspy__list">
                                            <li class="cp-scrollspy__item">
                                                ...
                                                <p class="cp-scrollspy__desc">
                                                   Tailor the billing experience around your customers' local language. With Chargebee and Checkout.com, <a href="https://www.chargebee.com/docs/configure-multiple-languages.html">localize</a> email notifications, invoices, customer portal, and checkout pages easily.
                                                </p>
                                            </li>
                                            <li class="cp-scrollspy__item">
                                                <h3 class="cp-scrollspy__heading">
                                            ...
                                            <li class="cp-scrollspy__item">
                                                ...
                                                <p class="cp-scrollspy__desc" >
                                                    <a href="/saas-accounting-and-taxes/revenue-recognition-deferred-revenue/">Recognize revenue</a> every month, determine pending revenue to be recognized for a subscription period and obtain a monthly account summary report with Chargebee and Checkout.com.
                                                </p>
                                            </li>
                                            <li class="cp-scrollspy__item">
                                                <h3 class="cp-scrollspy__heading">
                                    ...
                                    <div class="col-lg-8 col-lg-offset-2 col-md-10 col-md-offset-1">
                                        <div class="cp-clients__container">
                                            ...
                                            <ul class="cp-clients__logos">
                                                <li class="cp-clients__logo"><img class="img-responsive" src="/static/website/version/images/payment-gateways/adyen/salesforce.svg" style="margin-top: 7px;width: 100px;" alt="" width="155" /></li>
                                                <li class="cp-clients__logo hidden-xs"><img class="img-responsive" src="/static/website/version/images/payment-gateways/adyen/quickbooks-logo.png" style="margin-top: -7px" alt="" width="136" /></li>
                                                <li class="cp-clients__logo"><img class="img-responsive" src="/static/website/version/images/payment-gateways/adyen/freshdesk.png" alt="" width="166" /></li>
